...
public class CacheConfiguration {
    ...
    public InfinispanGlobalConfigurer globalConfiguration(JHipsterProperties jHipsterProperties) {
        log.info("Defining Infinispan Global Configuration");
            return () -> GlobalConfigurationBuilder
                    ...
                    .clusterName("infinispan-efactura3-cluster").globalJmxStatistics()
    ...
    class InfinispanJCacheManager extends JCacheManager {
        ...
        public InfinispanJCacheManager(URI uri, EmbeddedCacheManager cacheManager, CachingProvider provider,
            ...
            registerPredefinedCache(uy.com.equital.efactura.application.repository.UserRepository.USERS_BY_LOGIN_CACHE, new JCache<Object, Object>(
                cacheManager.getCache(uy.com.equital.efactura.application.repository.UserRepository.USERS_BY_LOGIN_CACHE).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(uy.com.equital.efactura.application.repository.UserRepository.USERS_BY_EMAIL_CACHE, new JCache<Object, Object>(
                cacheManager.getCache(uy.com.equital.efactura.application.repository.UserRepository.USERS_BY_EMAIL_CACHE).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(uy.com.equital.efactura.application.domain.User.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(uy.com.equital.efactura.application.domain.User.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(uy.com.equital.efactura.application.domain.Authority.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(uy.com.equital.efactura.application.domain.Authority.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(uy.com.equital.efactura.application.domain.User.class.getName() + ".authorities", new JCache<Object, Object>(
                cacheManager.getCache(uy.com.equital.efactura.application.domain.User.class.getName() + ".authorities").getAdvancedCache(), this,
                ConfigurationAdapter.create()));
